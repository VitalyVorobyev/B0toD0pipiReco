...
class B0UserInfo : public ParticleUserInfo{
public:
  B0UserInfo();
...
public:
  ...
  void MisMass(const double& v) {m_mismass = v;}
  double MisMass(void) const {return m_mismass;}
...
/////////////////
  ...
  void RawCosHel12(const double& v) {m_raw_cos_hel_dpip = v;}
  void RawCosHel13(const double& v) {m_raw_cos_hel_dpim = v;}
  void RawCosHel23(const double& v) {m_raw_cos_hel_pipi = v;}

  void RawMass12(const double& v) {m_dpip_raw_mass = v;}
  void RawMass13(const double& v) {m_dpim_raw_mass = v;}
  void RawMass23(const double& v) {m_pipi_raw_mass = v;}

  double RawCosHel12(void) const {return m_raw_cos_hel_dpip;}
  double RawCosHel13(void) const {return m_raw_cos_hel_dpim;}
  double RawCosHel23(void) const {return m_raw_cos_hel_pipi;}

  double RawMass12(void) const {return m_dpip_raw_mass;}
  double RawMass13(void) const {return m_dpim_raw_mass;}
  double RawMass23(void) const {return m_pipi_raw_mass;}
...
private:
  ...
  double m_raw_cos_hel_dpip;
  double m_raw_cos_hel_dpim;
  double m_raw_cos_hel_pipi;

  double m_dpip_raw_mass;
  double m_dpim_raw_mass;
  double m_pipi_raw_mass;
