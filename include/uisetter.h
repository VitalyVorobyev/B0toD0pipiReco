...
public:
  ...
  static void SetDslInfo(std::vector<Particle> &dsl);
  ...
  static int  SetRawDtoKspipiVars(Particle &d0);
  ...
  static void SetModeB0(std::vector<Particle> &pl, const int mode);
  ...
  static int  SetTrkInfo(Particle& trk);
  static void GetTrkFitInfo(Particle& trk,int& rphi,int& rz,double& r,double& z);
